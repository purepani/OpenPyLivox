                        ...
                        if ret_code != 0:
                            if self._showMessages:
                                print(
                                    ...
                                    + self._format_spaces
                                    + self._format_spaces
                                    + "   -->     incorrect heartbeat response"
                                )
                        else:
                            self.work_state = int.from_bytes(
                                ret_code_bin[1], byteorder="little"
                            )
...
class _dataCaptureThread(object):
            ...
            if version == 5:
                    ...
                    if self.started:
                        ...
                        if timeSinceStart <= self.secsToWait:
                            ...
                            if select.select([self.d_socket], [], [], 0)[0]:
                                data_pc, addr = self.d_socket.recvfrom(1500)
                                timestamp_type = int.from_bytes(
                                    data_pc[8:9], byteorder="little"
                                )
                                timestamp2 = self.getTimestamp(
                                    data_pc[10:18], timestamp_type
                                )
                                self.updateStatus(data_pc[4:8])
                        else:
                        ...
                        if timeSinceStart <= self.duration:
                            ...
                            if select.select([self.d_socket], [], [], 0)[0]:
                                ...
                                version = int.from_bytes(
                                    data_pc[0:1], byteorder="little"
                                )
                                slot_id = int.from_bytes(
                                    data_pc[1:2], byteorder="little"
                                )
                                lidar_id = int.from_bytes(
                                    data_pc[2:3], byteorder="little"
                                )
                                ...
                                timestamp_sec = self.getTimestamp(
                                    data_pc[10:18], timestamp_type
                                )
                ...
                if lenData > 0:
                    ...
                    if self.firmwareType == 1:
                        ...
                        if self.dataType == 0:
                            ...
                            for i in range(0, lenData):
                                coord1 = round(
                                    float(struct.unpack("<i", coord1s[i])[0]) / 1000.0,
                                    3,
                                )
                                coord2 = round(
                                    float(struct.unpack("<i", coord2s[i])[0]) / 1000.0,
                                    3,
                                )
                                coord3 = round(
                                    float(struct.unpack("<i", coord3s[i])[0]) / 1000.0,
                                    3,
                                )
                                if coord1 or coord2 or coord3:
                                    ...
                                    csvFile.write(
                                        ...
                                        + str(
                                            int.from_bytes(
                                                intensities[i], byteorder="little"
                                            )
                                        )
                                        + ","
                        ...
                        # Spherical
                            ...
                            for i in range(0, lenData):
                                ...
                                coord2 = round(
                                    float(struct.unpack("<H", coord2s[i])[0]) / 100.0, 2
                                )
                                coord3 = round(
                                    float(struct.unpack("<H", coord3s[i])[0]) / 100.0, 2
                                )
                                if coord1:
                                    numPts += 1
                                    csvFile.write(
                    ...
                    # multiple returns firmware
                        ...
                        # Spherical
                            ...
                            csvFile.write(
                                "//Distance,Zenith,Azimuth,Inten-sity,Time,ReturnNum\n"
                            )
                            for i in range(0, lenData):
                                coord1 = round(
                                    float(struct.unpack("<I", coord1s[i])[0]) / 1000.0,
                    ...
                    if self._showMessages:
                        print(
                            ...
                            + self.sensorIP
                            + self._format_spaces
                            + "   -->     WARNING: no point cloud data was captured"
                        )
                ...
                if self._showMessages:
                    print(
                        ...
                        + self.sensorIP
                        + self._format_spaces
                        + "   -->     Incorrect lidar packet version"
                    )
            ...
            if version == 5:
                ...
                if self._showMessages:
                    print(
                        ...
                        + self.sensorIP
                        + self._format_spaces
                        + "   -->     writing real-time data to ASCII file: "
                        + self.filePathAndName
                    )
                ...
                if self.firmwareType == 1:  # single return firmware
                    ...
                    self.firmwareType == 2 or self.firmwareType == 3
                ):  # double or triple return firmware
                    if self.dataType == 0:  # Cartesian
                        csvFile.write("//X,Y,Z,Inten-sity,Time,ReturnNum\n")
                    elif self.dataType == 1:  # Spherical
                        csvFile.write(
                                ...
                                if self.firmwareType == 1:
                                    ...
                                    if self.dataType == 0:
                                        for i in range(0, 100):
                                            ...
                                            coord2 = struct.unpack(
                                                "<i", data_pc[bytePos + 4 : bytePos + 8]
                                            )[0]
                                            ...
                                            if coord2:
                                                # X coordinate
                                                coord1 = struct.unpack(
                                                    "<i", data_pc[bytePos : bytePos + 4]
                                                )[0]
                                                bytePos += 8
                                                # Z coordinate
                                                coord3 = struct.unpack(
                                                    "<i", data_pc[bytePos : bytePos + 4]
                                                )[0]
                                                bytePos += 4
                                                # intensity
                                                intensity = int.from_bytes(
                                                    data_pc[bytePos : bytePos + 1],
                                                    byteorder="little",
                                                )
                                                bytePos += 1
            ...
            if version == 5:
                ...
                if self._showMessages:
                    print(
                        ...
                        + self.sensorIP
                        + self._format_spaces
                        + "   -->     writing real-time data to BINARY file: "
                        + self.filePathAndName
                    )
                    ...
                    if self.started:
                        ...
                        if timeSinceStart <= self.duration:
                            ...
                            if select.select([self.d_socket], [], [], 0)[0]:
                                ...
                                # update lidar status information
                                self.updateStatus(data_pc[4:8])
                                dataType = int.from_bytes(
                                    data_pc[9:10], byteorder="little"
                                )
                                timestamp_type = int.from_bytes(
                                    data_pc[8:9], byteorder="little"
                                )
                                    ...
                                    if dataType == 0:
                                        ...
                                        for i in range(0, 100):
                                            ...
                                            if deviceCheck == 100:
                                                numPts += 1
                                                binFile.write(
                                                    data_pc[bytePos : bytePos + 13]
                                                )
                                                binFile.write(
                                                    struct.pack("<d", timestamp_sec)
                                                )
                                            else:
                                                if coord2:
                                                    numPts += 1
                            ...
                            if select.select([self.i_socket], [], [], 0)[0]:
                                ...
                                dataType = int.from_bytes(
                                    imu_data[9:10], byteorder="little"
                                )
                                timestamp_type = int.from_bytes(
                                    imu_data[8:9], byteorder="little"
                                )
                                timestamp_sec = self.getTimestamp(
                                    imu_data[10:18], timestamp_type
                                )
    ...
    def getTimestamp(self, data_pc, timestamp_type):
        ...
        if timestamp_type == 0 or timestamp_type == 1 or timestamp_type == 4:
            timestamp_sec = round(
                float(struct.unpack("<Q", data_pc[0:8])[0]) / 1000000000.0, 6
            )  # convert to seconds
        ...
        # UTC timestamp, microseconds past the hour
            ...
            timestamp_sec = round(
                float(struct.unpack("<L", data_pc[4:8])[0]) / 1000000.0, 6
            )  # convert to seconds

            timestamp_sec += timestamp_hour * 3600.0  # seconds into the day
    ...
    def updateStatus(self, data_pc):
        status_bits = str(bin(int.from_bytes(data_pc[0:1], byteorder="little")))[
            2:
        ].zfill(8)
        status_bits += str(bin(int.from_bytes(data_pc[1:2], byteorder="little")))[
            2:
        ].zfill(8)
        status_bits += str(bin(int.from_bytes(data_pc[2:3], byteorder="little")))[
            2:
        ].zfill(8)
        status_bits += str(bin(int.from_bytes(data_pc[3:4], byteorder="little")))[
            2:
        ].zfill(8)
                ...
                if self.system_status == 1:
                    ...
                    if self.device_status == 1:
                        print(
                            ...
                            + self.sensorIP
                            + self._format_spaces
                            + "   -->     * WARNING: approaching end of service life *"
                        )
...
class openpylivox(object):
    ...
    _CMD_READ_EXTRINSIC = bytes.fromhex(
        (b"AA010F0000000004D70102EFBB9162").decode("ascii")
    )
    ...
    _CMD_RAIN_FOG_ON = bytes.fromhex(
        (b"AA011000000000B809010301D271D049").decode("ascii")
    )
    _CMD_RAIN_FOG_OFF = bytes.fromhex(
        (b"AA011000000000B8090103004441D73E").decode("ascii")
    )
    _CMD_LIDAR_START = bytes.fromhex(
        (b"AA011000000000B8090100011122FD62").decode("ascii")
    )
    _CMD_LIDAR_POWERSAVE = bytes.fromhex(
        (b"AA011000000000B809010002AB73F4FB").decode("ascii")
    )
    _CMD_LIDAR_STANDBY = bytes.fromhex(
        (b"AA011000000000B8090100033D43F38C").decode("ascii")
    )
    _CMD_DATA_STOP = bytes.fromhex(
        (b"AA011000000000B809000400B4BD5470").decode("ascii")
    )
    _CMD_DATA_START = bytes.fromhex(
        (b"AA011000000000B809000401228D5307").decode("ascii")
    )
    _CMD_CARTESIAN_CS = bytes.fromhex(
        (b"AA011000000000B809000500F58C4F69").decode("ascii")
    )
    _CMD_SPHERICAL_CS = bytes.fromhex(
        (b"AA011000000000B80900050163BC481E").decode("ascii")
    )
    ...
    _CMD_LIDAR_SINGLE_1ST = bytes.fromhex(
        (b"AA011000000000B80901060001B5A043").decode("ascii")
    )
    _CMD_LIDAR_SINGLE_STRONGEST = bytes.fromhex(
        (b"AA011000000000B8090106019785A734").decode("ascii")
    )
    _CMD_LIDAR_DUAL = bytes.fromhex(
        (b"AA011000000000B8090106022DD4AEAD").decode("ascii")
    )
    _CMD_IMU_DATA_ON = bytes.fromhex(
        (b"AA011000000000B80901080119A824AA").decode("ascii")
    )
    _CMD_IMU_DATA_OFF = bytes.fromhex(
        (b"AA011000000000B8090108008F9823DD").decode("ascii")
    )

    _CMD_REBOOT = bytes.fromhex((b"AA011100000000FC02000A000004477736").decode("ascii"))

    _CMD_DYNAMIC_IP = bytes.fromhex(
        (b"AA011400000000A8240008000000000068F8DD50").decode("ascii")
    )
    _CMD_WRITE_ZERO_EO = bytes.fromhex(
        (
            b"AA012700000000B5ED01010000000000000000000000000000000000000000000000004CDEA4E7"
        ).decode("ascii")
    )

    _SPECIAL_FIRMWARE_TYPE_DICT = {
        "03.03.0001": 2,
        "03.03.0002": 3,
        "03.03.0006": 2,
        "03.03.0007": 3,
    ...
    def _reinit(self):
        ...
        lidarSensorIPs, serialNums, ipRangeCodes, sensorTypes = self._searchForSensors(
            False
        )
        ...
        if foundMatchIP == False:
            ...
            print(
                "* common causes are a wrong IP or the command port is being used already   *\n"
            )
            time.sleep(0.1)
            sys.exit(2)
                ...
                if ret_code == 1:
                    if self._showMessages:
                        print(
                            ...
                            + self._sensorIP
                            + self._format_spaces
                            + "   -->     FAILED to receive query results"
                        )
                elif ret_code == 0:
                    AA = str(int.from_bytes(ret_code_bin[1], byteorder="little")).zfill(
                        2
                    )
                    BB = str(int.from_bytes(ret_code_bin[2], byteorder="little")).zfill(
                        2
                    )
                    CC = str(int.from_bytes(ret_code_bin[3], byteorder="little")).zfill(
                        2
                    )
                    DD = str(int.from_bytes(ret_code_bin[4], byteorder="little")).zfill(
                        2
                    )
    ...
    def _info(self, binData):
        ...
        if goodData:
            ...
            if (
                ...
                ipRangeCode = int(
                    device_broadcast_code[14:15]
                )  # used to define L,M,R sensors in the Mid-100
    ...
    def _parseResp(self, binData):
        ...
        frame_header_checksum_crc16 = int.from_bytes(
            (dataBytes[7] + dataBytes[8]), byteorder="little"
        )
        ...
        if frame_header_checksum_crc16 == checkSum16I:
            ...
            frame_header_checksum_crc32 = int.from_bytes(
                (
                    ...
                    + dataBytes[dataLength - 1]
                ),
                byteorder="little",
            )

            if frame_header_checksum_crc32 == checkSum32I:
                frame_sof = int.from_bytes(
                    dataBytes[0], byteorder="little"
                )  # should be 170 = '\xAA'
                frame_version = int.from_bytes(
                    dataBytes[1], byteorder="little"
                )  # should be 1
                frame_length = int.from_bytes(
                    (dataBytes[2] + dataBytes[3]), byteorder="little"
                )  # max value = 1400

                if frame_sof == 170:
                    if frame_version == 1:
                        if frame_length <= 1400:
                            frame_cmd_type = int.from_bytes(
                                dataBytes[4], byteorder="little"
                            )
                            ...
                            frame_data_cmd_set = int.from_bytes(
                                dataBytes[9], byteorder="little"
                            )
                            ...
                            dataID = str(
                                int.from_bytes(dataBytes[10], byteorder="little")
                            )
                            data = dataBytes[11:]
    ...
    def discover(self, manualComputerIP=""):
        ...
        if self._computerIP:
            ...
            if len(unique_serialNums) > 0:
                ...
                print(
                    "Did not discover any Livox sensors, check communication and power cables and network settings"
                )
    ...
    def connect(
        self, computerIP, sensorIP, dataPort, cmdPort, imuPort, sensor_name_override=""
    ):
        numFound = 0
        ...
        if not self._isConnected:
            ...
            if (
                ...
                if select.select([self._cmdSocket], [], [], 0.1)[0]:
                    ...
                    if (
                        ...
                        if ret_code == 0:
                            ...
                            if self._showMessages:
                                print(
                                    "Connected to the Livox "
                                    + self._deviceType
                                    + " at IP: "
                                    + self._sensorIP
                                    + " (ID: "
                                    + str(self._ipRangeCode)
                                    + ")"
                                )
                        else:
                            if self._showMessages:
                                print(
                                    "FAILED to connect to the Livox "
                                    + self._deviceType
                                    + " at IP: "
                                    + self._sensorIP
                                )
                ...
                if self._showMessages:
                    print("Invalid connection parameter(s)")
        else:
            if self._showMessages:
                print(
                    "Already connected to the Livox "
                    + self._deviceType
                    + " at IP: "
                    + self._sensorIP
                )
    ...
    def auto_connect(self, manualComputerIP=""):
        ...
        if self._computerIP:
            ...
            if len(unique_sensors) > 0 and unique_sensors[0] != "NA":
                ...
                if self._showMessages:
                    print(
                        "Attempting to auto-connect to the Livox "
                        + unique_sensors[0]
                        + " with S/N: "
                        + unique_serialNums[0]
                    )
                ...
                if unique_sensors[0] == "Mid-100":
                    ...
                    for i in range(3):
                        if int(sensor_IDs[i]) == 1:
                            self.connect(
                                self._computerIP, sensor_IPs[i], 0, 0, 0, "Mid-100 (L)"
                            )
                            for j in range(3):
                    ...
                    numFound = self.connect(
                        self._computerIP, lidarSensorIPs[0], 0, 0, 0
                    )
            ...
            if self._showMessages:
                print("*** ERROR: Failed to auto determine the computer IP address ***")
    ...
    def _disconnect(self):
        if self._isConnected:
            ...
            try:
                ...
                if self._showMessages:
                    print(
                        "*** Error trying to disconnect from the Livox "
                        + self._deviceType
                        + " at IP: "
                        + self._sensorIP
                    )
    ...
    def _reboot(self):
        if self._isConnected:
            ...
            try:
                ...
                if self._showMessages:
                    print(
                        "*** Error trying to reboot from the Livox "
                        + self._deviceType
                        + " at IP: "
                        + self._sensorIP
                    )
    ...
    def _lidarSpinUp(self):
        if self._isConnected:
            ...
            if self._showMessages:
                print("Not connected to Livox sensor at IP: " + self._sensorIP)
            ...
            if stopper:
                ...
                for i in range(len(self._mid100_sensors)):
                    if self._mid100_sensors[i]._showMessages:
                        print(
                            "   "
                            + self._mid100_sensors[i]._sensorIP
                            + self._mid100_sensors[i]._format_spaces
                            + "   -->     lidar is ready"
                        )
                time.sleep(0.1)
                break
                    ...
                    if ret_code == 1:
                        if self._showMessages:
                            print(
                                ...
                                + self._sensorIP
                                + self._format_spaces
                                + "   -->     FAILED to set lidar to stand-by"
                            )
                    else:
                        self._isData = False
                        if self._captureStream is not None:
    ...
    def dataStart(self):
        if self._isConnected:
            if not self._isData:
                self._captureStream = _dataCaptureThread(
                    self._sensorIP,
                    self._dataSocket,
                    "",
                    0,
    ...
    def setStaticIP(self, ipAddress):
        if self._isConnected:
            ...
            if ipAddress:
                ...
                cmdString = (
                    "AA011400000000a824000801" + IPhex1 + IPhex2 + IPhex3 + IPhex4
                )
                binString = bytes(cmdString, encoding="utf-8")
                crc32checksum = self._crc32fromStr(binString)
                cmdString += crc32checksum
                        ...
                        if ret_code == 0:
                            ...
                            if self._showMessages:
                                print(
                                    ...
                                    + self._sensorIP
                                    + self._format_spaces
                                    + "   -->     FAILED to change static IP (must be "
                                    + ipRange
                                    + ")"
                                )
                    else:
        ...
        if self._isConnected:
            ...
            if self._showMessages:
                print(
                    ...
                    + self._sensorIP
                    + self._format_spaces
                    + "   <--     sent change to Cartesian coordinates request"
                )
                    ...
                    if ret_code == 1:
                        if self._showMessages:
                            print(
                                ...
                                + self._sensorIP
                                + self._format_spaces
                                + "   -->     FAILED to set Cartesian coordinate output"
                            )
                    elif ret_code == 0:
                        self._coordSystem = 0
                else:
            ...
            if select.select([self._cmdSocket], [], [], 0.1)[0]:
                ...
                if ack == "ACK (response)" and cmd_set == "Lidar" and cmd_id == "2":
                    ...
                    if ret_code == 1:
                        ...
                        x = float(struct.unpack("<i", binData[24:28])[0]) / 1000.0
                        y = float(struct.unpack("<i", binData[28:32])[0]) / 1000.0
                        z = float(struct.unpack("<i", binData[32:36])[0]) / 1000.0
    ...
    def setExtrinsicTo(self, x, y, z, roll, pitch, yaw):
        if self._isConnected:
            goodValues = True
            try:
                xi = int(np.floor(x * 1000.0))  # units of millimeters
                yi = int(np.floor(y * 1000.0))  # units of millimeters
                zi = int(np.floor(z * 1000.0))  # units of millimeters
                rollf = float(roll)
                pitchf = float(pitch)
                yawf = float(yaw)
    ...
    def _updateUTC(self, year, month, day, hour, microsec):
        if self._isConnected:
            ...
            cmdString = (
                "AA0117000000006439010A" + year_b + month_b + day_b + hour_b + sec_b
            )
            binString = bytes(cmdString, encoding="utf-8")
            crc32checksum = self._crc32fromStr(binString)
            cmdString += crc32checksum
    ...
    def setLidarReturnMode(self, Mode_ID):
        if self._isConnected:
            ...
            # single first return
            if Mode_ID == 0:
                self._cmdSocket.sendto(
                    self._CMD_LIDAR_SINGLE_1ST, (self._sensorIP, 65000)
                )
                if self._showMessages:
                    print(
                        "   "
            ...
            # single strongest return
                ...
                self._cmdSocket.sendto(
                    self._CMD_LIDAR_SINGLE_STRONGEST, (self._sensorIP, 65000)
                )
                if self._showMessages:
                    print(
                        "   "
        ...
        if self._isConnected:
            ...
            if self._showMessages:
                print(
                    ...
                    + self._sensorIP
                    + self._format_spaces
                    + "   <--     sent get IMU push state request"
                )
                            ...
                            if secsToWait < 0:
                                ...
                                if secsToWait > 900:
                                    ...
                                    if filePathAndName == "":
                                        ...
                                        self._captureStream.filePathAndName = (
                                            filePathAndName
                                        )
                                        ...
                                        self._captureStream._showMessages = (
                                            self._showMessages
                                        )
                                        time.sleep(0.1)
            ...
            if self._showMessages:
                ...
                for i in range(len(self._mid100_sensors)):
                    print(
                        ...
                        + self._mid100_sensors[i]._format_spaces
                        + "   -->     F/W Version: "
                        + self._mid100_sensors[i]._firmware
                    )
                    ...
                    if firmwareType >= 1 and firmwareType <= 3:
                        if dataType >= 0 and dataType <= 5:
                            ...
                            if firmwareType == 1 and dataType == 0:
                                ...
                                csvFile.write(
                                    "//X,Y,Z,Inten-sity,Time,ReturnNum,ReturnType,sConf,iConf\n"
                                )
                                dataClass = 5
                                divisor = 22
                            ...
                            while True:
                                try:
                                    ...
                                    if dataClass == 1:
                                        coord1 = (
                                            float(
                                                struct.unpack("<i", binFile.read(4))[0]
                                            )
                                            / 1000.0
                                        )
                                        coord2 = (
                                        ...
                                        intensity = int.from_bytes(
                                            binFile.read(1), byteorder="little"
                                        )
                                        timestamp_sec = float(
                                            struct.unpack("<d", binFile.read(8))[0]
                                        )
                                        csvFile.write(
                                            "{0:.3f}".format(coord1)
                                            + ","
                                    ...
                                    # Mid-40/100 Spherical single return
                                        ...
                                        coord2 = (
                                            float(
                                                struct.unpack("<H", binFile.read(2))[0]
                                            )
                                            / 100.0
                                        )
                                        coord3 = (
                            ...
                            print(
                                "*** ERROR: The OPL point data binary file reported a wrong data type ***"
                            )
                            binFile.close()
                    else:
                        print(
                            "*** ERROR: The OPL point data binary file reported a wrong firmware type ***"
                        )
                        binFile.close()
                ...
                if os.path.exists(IMU_file) and os.path.isfile(IMU_file):
                    ...
                    if checkMessage == "OPENPYLIVOX_IMU":
                        with open(IMU_file + ".csv", "w", 1) as csvFile2:
                            csvFile2.write(
                                "//gyro_x,gyro_y,gyro_z,acc_x,acc_y,acc_z,time\n"
                            )
                            pbari2 = tqdm(total=num_recs, unit=" records", desc="   ")
                            while True:
                                try:
                                    gyro_x = "{0:.6f}".format(
                                        struct.unpack("<f", binFile2.read(4))[0]
                                    )
                                    gyro_y = "{0:.6f}".format(
                                        struct.unpack("<f", binFile2.read(4))[0]
                                    )
                                    ...
                                    timestamp_sec = "{0:.6f}".format(
                                        struct.unpack("<d", binFile2.read(8))[0]
                                    )
                            ...
                            binFile2.close()
                            print(
                                "   - IMU data was converted successfully to CSV, see file: "
                                + IMU_file
                                + ".csv"
                            )
                            if deleteBin:
                                os.remove(IMU_file)
                                print(
                                    "     * OPL IMU data binary file has been deleted"
                                )
                    else:
                        print(
                            "*** ERROR: The file was not recognized as an OpenPyLivox binary IMU data file ***"
                        )
                        binFile2.close()
            else:
                print(
                    "*** ERROR: The file was not recognized as an OpenPyLivox binary point data file ***"
                )
                binFile.close()
    except:
        binFile.close()
        print(
            "*** ERROR: An unknown error occurred while converting OPL binary data ***"
        )
                    ...
                    if dataType == 0 or dataType == 2 or dataType == 4:
                        ...
                        while True:
                            try:
                                ...
                                if dataClass == 1:
                                    coord1s.append(
                                        float(struct.unpack("<i", binFile.read(4))[0])
                                        / 1000.0
                                    )
                                    coord2s.append(
                                        float(struct.unpack("<i", binFile.read(4))[0])
                                    ...
                                    times.append(
                                        float(struct.unpack("<d", binFile.read(8))[0])
                                    )
                                    returnNums.append(1)
                                ...
                                # Mid-40/100 Cartesian multiple return
                                    ...
                                    returnNums.append(
                                        int((binFile.read(1)).decode("UTF-8"))
                                    )
                                ...
                                # Horizon/Tele-15 Cartesian single return (SDK Data Type 2)
                                    ...
                                    intensity.append(
                                        struct.unpack("<B", binFile.read(1))[0]
                                    )
                                    tag_bits = str(
                                        bin(
                                            int.from_bytes(
                        ...
                        print(
                            "*** ERROR: Only Cartesian point data can be converted to an LAS file ***"
                        )
                        binFile.close()
                else:
                    print(
